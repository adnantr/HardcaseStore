    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureApplicationCookie(options =>
            {
                ...
                options.LoginPath = "/Admin/Login/"; //giriþ
                options.LogoutPath = "/Admin/LogOut"; //çýkýþ
                options.AccessDeniedPath = "/Admin/AccessDenied"; //yetkisiz giriþ "Sayfa oluþturulmalý"
                options.SlidingExpiration = false; //süreli oturum
                options.Cookie = new CookieBuilder
                {
                    HttpOnly = true,
                    Name = ".Menu.Security.Cookie",
